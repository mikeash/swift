...
template<typename Ret, typename Param> Param returnTypeHelper(Ret (*)(Param)) {}
...
#define CUSTOM_RR_ENTRYPOINTS_DEFINE_ENTRYPOINTS(function) \
  CUSTOM_RR_ENTRYPOINTS_FOREACH_REG(CUSTOM_RR_ENTRYPOINTS_DEFINE_ONE_ENTRYPOINT, function)
